            ...
            <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
                <header className="h-16 bg-white border-b border-border-color flex items-center justify-between px-4 sm:px-8 sticky top-0 z-20 flex-shrink-0">
                    <div className="flex items-center gap-4 flex-1">
                        ...
                        <div className="hidden sm:flex items-center borde border-gray-300 rounded-lg px-3 py-2 w-full max-w-[400px]">
                    ...
                    <div className="flex items-center gap-2 sm:gap-4">
                        <div className="flex items-center gap-1 sm:gap-2 mr-2">
                            ...
                            <button className="hidden sm:flex p-2 rounded-full hover:bg-gray-100 text-text-secondary transition-colors">
                                <Maximize size={20} />
                            </button>
                        </div>

                        <div className="flex items-center gap-3 cursor-pointer hover:bg-gray-50 p-1 rounded-lg transition-colors border border-transparent hover:border-gray-100">
                            <div className="">
                                {user?.avatar ? (
                                    <img
                            ...
                            <div className="text-left hidden sm:block pr-1">
                                ...
                                <p className="text-[12px] text-text-secondary">{user?.role || "Admin"}</p>
                            </div>
                        </div>
                    </div>
                </header>
